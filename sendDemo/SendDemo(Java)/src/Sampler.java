...
public class Sampler
{
	...
	// 接口帐号
	private static final String account = "1001@501020570001";
	
	// 接口密钥
	private static final String authkey = "0A26B6ADD3CFF0FA17A1BD5A3653B623";
	...
	public static void main(String[] args) throws Exception
	{
		...
		List<SendResultBean> listItem = sendOnce("15618569600", "Java接口测试内容");
		if(listItem != null)
		{
